...
export default function TeamsPage() {
  ...
  return (
    <div className="flex h-full flex-col space-y-8">
              ...
              >
                <Card className="group flex h-full cursor-pointer flex-col border-gray-200 p-6 transition-all hover:border-blue-200 hover:shadow-md">
                  <div className="mb-4 flex items-start justify-between">
                    <div className="rounded-xl bg-indigo-50 p-2.5 transition-colors group-hover:bg-indigo-100">
                      <Users className="h-5 w-5 text-indigo-600" />
                    </div>
                  </div>

                  <div className="flex-1">
                    <h3 className="mb-2 text-lg font-semibold text-gray-900 transition-colors group-hover:text-indigo-700">
                      {team.name}
                    </h3>
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-gray-100 pt-4 text-xs text-gray-500">
                    ...
                    <div className="flex items-center gap-1 font-medium text-indigo-600 opacity-0 transition-opacity group-hover:opacity-100">
      ...
      <TeamModal isOpen={isDialogOpen} onClose={() => setIsDialogOpen(false)} />
    </div>
  );
}
