...
export function WorkspaceSwitcher() {
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute top-full left-0 z-50 mt-1 w-full overflow-hidden rounded-md border border-gray-200 bg-white shadow-lg">
            ...
            {workspaces.length === 0 ? (
              ...
              workspaces.map((workspace) => (
                <button
                  ...
                  className={cn(
                    "relative flex w-full cursor-pointer items-center rounded-sm px-2 py-2 text-sm outline-none select-none hover:bg-blue-50 hover:text-blue-600",
          ...
          <div className="border-t border-gray-100 p-1">
            ...
            >
              <span className="mr-2 flex h-4 w-4 items-center justify-center text-lg leading-none">
                +
              </span>
              Create Workspace
            </button>
