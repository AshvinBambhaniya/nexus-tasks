...
<template>
  <div class="flex min-h-screen flex-col bg-white selection:bg-blue-100">
    ...
    <main class="flex-1">
      <!-- Hero Section -->
      <section class="relative overflow-hidden pt-20 pb-28 lg:pt-32 lg:pb-40">
        <div
          class="relative z-10 container mx-auto px-4 text-center sm:px-6 lg:px-8"
        >
      ...
      <section
        id="features"
        class="border-t border-gray-100 bg-gray-50/50 py-24"
      >
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p class="leading-relaxed text-gray-500">
                Write task descriptions and comments using standard Markdown.
                Code blocks, lists, and formatting just work.
              </p>
            </div>
            ...
            >
              ...
              <p class="leading-relaxed text-gray-500">
                Collaborate without refreshing. See comments, status changes,
                and new tasks appear instantly via WebSockets.
              </p>
            </div>
            ...
            >
              ...
              <p class="leading-relaxed text-gray-500">
                Manage tasks with a familiar flow: Open, In Progress, Done.
                Track history and discussions linearly.
              </p>
            </div>
            ...
            <div class="relative z-10 mx-auto max-w-2xl">
              ...
              <NuxtLink to="/register">
                <UiBaseButton
                  variant="white"
                  size="lg"
                  class="h-14 px-8 text-base font-semibold"
                >
    ...
    <footer class="border-t border-gray-100 bg-white py-12">
      <div
        class="container mx-auto flex flex-col items-center justify-between gap-6 px-4 sm:px-6 md:flex-row lg:px-8"
      >
        <div class="flex items-center gap-2">
          <div
