...
<template>
  <div
    class="group flex items-start gap-3 border-b border-gray-100 p-4 transition-colors last:border-0 hover:bg-gray-50"
  >
    ...
    <div class="flex shrink-0 items-center gap-4 text-gray-400">
      <div v-if="(task.comment_count ?? 0) > 0" class="flex items-center gap-1 text-xs">
